...
function get(i){
 ...
 return {index:i,id:"CASE-"+String(i+1).padStart(4,"0"),title:`${titleA[i%titleA.length]} ${titleB[(i*7)%titleB.length]} ${i+1}`,city:city[0],country:city[1],sceneType:archetypes[i%archetypes.length],sceneImage:`assets/scenes520/case_${String(i+1).padStart(4,"0")}.svg`,scope:p.scope,difficulty,reward:280+difficulty*11+(special?250:0),special,
